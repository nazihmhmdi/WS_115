...
import com.pws5.exceptions.NonexistentEntityException;
import com.pws5.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.pws_115_jar_0.0.1-SNAPSHOTPU");
